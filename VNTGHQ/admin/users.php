...
$dataStmt = $pdo->prepare(
    "SELECT u.id, u.username, u.firstname, u.lastname, u.email, u.phone,
            u.provider, u.status, u.is_seller, u.seller_shop_name, u.created_at,
        ...
        <table class="table admin-table align-middle mb-0">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <?php if($u['is_seller']??0): ?>
                <span style="background:rgba(34,197,94,0.12);color:#16a34a;font-size:10px;font-weight:700;padding:3px 10px;border-radius:50px">Seller</span>
                <?php else: ?>
                <span style="background:var(--gray-100);color:var(--gray-400);font-size:10px;font-weight:700;padding:3px 10px;border-radius:50px">Buyer</span>
                <?php endif; ?>
              </td>
